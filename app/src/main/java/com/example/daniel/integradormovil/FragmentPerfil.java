...
public class FragmentPerfil extends Fragment {
    ...
    public TextView mNombreView,mCorreoView;
    private FirebaseAuth mAuth;
    DatabaseReference mDatabaseReference = FirebaseDatabase.getInstance().getReference();
    DatabaseReference mRootChild = mDatabaseReference.child("usuario/12345678/nombre");

    // DatabaseReference mRootChild = mDatabaseReference.child("ahorrado");
   ...
   public static FragmentPerfil newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mNombreView = (TextView)v.findViewById(R.id.txtnombreperfil);
       // mCorreoView = (TextView)v.findViewById(R.id.txtcorreoperfil);
        return v;
    }
    ...
    public void onStart() {
        ...
        mRootChild.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mNombreView.setText(texto);
               // mCorreoView.setText(texto);
